...
export function VisaSelector() {
  return (
    <div className="flex flex-col w-[95%] overflow-hidden rounded-xl bg-white shadow-[0_24px_48px_0_rgba(0,0,0,0.08)] sm:flex-row py-1.5 ">
      <div className="flex w-full items-center">
        {/* Where am I from? */}
        <div className="flex flex-1 flex-col p-5 ">
          <span className="mb-2 block text-sm font-semibold text-primary-copy">
            Where am I from?
          </span>
          <button
            type="button"
        ...
        <div className="shrink-0 p-3">
          <a
            href="#visa"
            className="flex items-center gap-3 rounded-full bg-primary px-6 py-4 text-base font-medium text-white transition hover:bg-primary-dark"
          >
