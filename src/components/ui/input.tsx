...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        "w-full min-w-0 bg-white border border-border-default px-6 py-4 rounded-2xl shadow-[0px_2px_4px_0px_#0000000A] text-primary-copy text-base focus:outline-none focus:ring-2 focus:ring-primary transition-shadow duration-200",
