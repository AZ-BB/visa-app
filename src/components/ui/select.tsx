...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "h-auto min-h-12 w-full rounded-xl border border-[#DAE0E5] bg-white px-4 py-2.5 shadow-[0px_2px_4px_0px_#0000000A]",
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "hover:bg-gray-100 focus:bg-gray-100 focus:outline-none data-[highlighted]:bg-gray-100",
    ...
    >
      ...
      >
        <SelectPrimitive.ItemIndicator>
          <CheckIcon className="size-4 text-primary-copy" />
        </SelectPrimitive.ItemIndicator>
      </span>
