...
interface ApplyFormSectionProps {
  user: AuthUser;
  products: (Tables<"products"> & { visa: Tables<"visa_types"> })[]
  destinationCountry: Tables<"countries">
  passportCountry: Tables<"countries">
  rules: Tables<"visa_rules">
}
...
export function ApplyFormSection({
  ...
  const handleStartApplication = () => {
    ...
    if (user?.profile) {
      travellers[0].first_name = user.profile.first_name
      travellers[0].last_name = user.profile.last_name
    }
  ...
  function handleNationalityChange(value: string) {
    router.push(`/${destinationCountry.id}/apply?from=${value}`)
  }
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className={cn(
                  "size-12 rounded-2xl border-2 border-border-default shadow-sm hover:text-primary",
                  numberOfTravellers <= 1
                    ? "bg-muted/30 text-muted-foreground border-border-default/70"
              ...
              <Button
                ...
                className={cn(
                  "size-12 rounded-2xl border-2 border-border-default bg-white shadow-sm hover:bg-gray-50 text-primary-copy hover:text-primary",
                ...
                <div className="size-12 shrink-0 bg-[#FFF2EB] rounded-full flex items-center justify-center">
                  ...
                  >
                    <g clipPath="url(#clip0_2035_540)">
                      <path
                        opacity="0.4"
                        d="M3.00011 6.54842C3.02354 10.8328 4.80011 18.2344 11.7376 21.5531C11.9064 21.6328 12.1032 21.6328 12.2673 21.5531C19.2048 18.2344 20.9814 10.8375 21.0001 6.54842C21.0001 6.31405 20.8548 6.0703 20.5782 5.94843L12.0001 2.31561L3.42198 5.95311C3.14542 6.0703 2.99542 6.31874 3.00011 6.55311V6.54842ZM6.70323 11.2031C7.14386 10.7625 7.85636 10.7625 8.29229 11.2031L10.4954 13.4062L15.7032 8.20311C16.1439 7.76249 16.8564 7.76249 17.2923 8.20311C17.7282 8.64374 17.7329 9.35624 17.2923 9.79217L11.297 15.7969C10.8564 16.2375 10.1439 16.2375 9.70792 15.7969L6.70792 12.7969C6.26729 12.3562 6.26729 11.6437 6.70792 11.2078L6.70323 11.2031Z"
                        fill="#FD7835"
                      />
                      <path
                        d="M3.4219 5.95313L12 2.31563L20.5781 5.95313C20.8547 6.07031 21.0047 6.31875 21 6.55313C20.9813 10.8375 19.2 18.2391 12.2672 21.5578C12.0985 21.6375 11.9016 21.6375 11.7375 21.5578C4.80002 18.2344 3.02346 10.8375 3.00002 6.54844C3.00002 6.31406 3.14533 6.07031 3.4219 5.94844V5.95313ZM21.4547 3.88125L12.6281 0.135938C12.4313 0.046875 12.2203 0 12 0C11.7797 0 11.5688 0.046875 11.3719 0.135938L2.54533 3.88125C1.51408 4.31719 0.745334 5.33438 0.750021 6.5625C0.773459 11.2125 2.68596 19.7203 10.7625 23.5875C11.5453 23.9625 12.4547 23.9625 13.2375 23.5875C21.3188 19.7203 23.2266 11.2125 23.25 6.5625C23.2547 5.33438 22.486 4.31719 21.4547 3.88125ZM17.2969 9.79688C17.7375 9.35625 17.7375 8.64375 17.2969 8.20781C16.8563 7.77188 16.1438 7.76719 15.7078 8.20781L10.5047 13.4109L8.30158 11.2078C7.86096 10.7672 7.14846 10.7672 6.71252 11.2078C6.27658 11.6484 6.2719 12.3609 6.71252 12.7969L9.71252 15.7969C10.1531 16.2375 10.8656 16.2375 11.3016 15.7969L17.2969 9.79688Z"
                        fill="#FD7835"
                      />
                    </g>
                    <defs>
                ...
                <div className="size-12 shrink-0 bg-[#FFF2EB] rounded-full flex items-center justify-center">
                  ...
                  >
                    <g clipPath="url(#clip0_2035_548)">
                      <path
                        opacity="0.4"
                        d="M2.14282 9V21C2.14282 21.4125 2.46425 21.75 2.85711 21.75H17.1428C17.5357 21.75 17.8571 21.4125 17.8571 21V9H2.14282ZM5.31246 14.5781C5.73211 14.1375 6.41068 14.1375 6.82586 14.5781L8.92407 16.7812L13.1651 12.3281C13.5848 11.8875 14.2634 11.8875 14.6785 12.3281C15.0937 12.7687 15.0982 13.4812 14.6785 13.9172L9.68746 19.1719C9.26782 19.6125 8.58925 19.6125 8.17407 19.1719L5.31693 16.1719C4.89729 15.7312 4.89729 15.0188 5.31693 14.5828L5.31246 14.5781Z"
                        fill="#FD7835"
                      />
                      <path
                        d="M5.71429 0C6.30804 0 6.78571 0.501562 6.78571 1.125V3H13.2143V1.125C13.2143 0.501562 13.692 0 14.2857 0C14.8795 0 15.3571 0.501562 15.3571 1.125V3H17.1429C18.7188 3 20 4.34531 20 6V6.75V9V21C20 22.6547 18.7188 24 17.1429 24H2.85714C1.28125 24 0 22.6547 0 21V9V6.75V6C0 4.34531 1.28125 3 2.85714 3H4.64286V1.125C4.64286 0.501562 5.12054 0 5.71429 0ZM17.8571 9H2.14286V21C2.14286 21.4125 2.46429 21.75 2.85714 21.75H17.1429C17.5357 21.75 17.8571 21.4125 17.8571 21V9Z"
                        fill="#FD7835"
                      />
                    </g>
                    <defs>
