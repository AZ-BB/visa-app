-- RPC to list applications for admin with search, filters, pagination, and sort
...
BEGIN
  ...
  INTO v_total
  USING p_search, p_status, p_assigned_to_id, p_destination_id, p_nationality_id;
  ...
  INTO v_rows
  USING p_search, p_status, p_assigned_to_id, p_destination_id, p_nationality_id, greatest(p_limit, 1), v_offset;
